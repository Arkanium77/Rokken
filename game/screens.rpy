...
#АТТЕНШН ХАРДКОР ЮЗЕРСКРИН
screen letter:
  default text = ""
  frame:
    text "[text]"

##АТТЕНШН ХАРДКОР ЮЗЕРСКРИН ИЗ ЭНД
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("Налево") action Preference("rollback side", "left")
                    textbutton _("Направо") action Preference("rollback side", "right")
