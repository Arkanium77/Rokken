...
define config.name = _("Rokken")
#define config.name = _("{image=images/rok1.png}")
...
define gui.about = _("Роккен - визуальная новелла, созданная по мотивам Umineko no Naku Koro Ni, разработанной 07th Expansion\n\nПри разработке этой новеллы мы использовали оригинальные материалы из игр 07th Expansion, а потому не претендуем ни на какие права.\n Все персонажи, изображения и музыка принадлежат их законным владельцам. \n\nНовелла разработана в учебных целях Шмаковой Натальей и Гржибовским Никитой.")
...
define config.main_menu_music = "sounds/music/vm/Kiseki.mp3"
...
define config.save_directory = "Rokken-1507750690"
